/*
Wed Oct 15 2014 18:59:09 GMT+0800 (中国标准时间)
combined files by KMD:

index.js
*/

KISSY.add('kg/progressbar/1.0.0/index',[],function(S ,require, exports, module) {
KISSY.add(function(S, Node, Event,Shifty) {
    var EASING_ALIASES = {
        easeIn: 'easeInCubic',
    ...
    requires : [ "node","event","./lib/shifty"]
});
});